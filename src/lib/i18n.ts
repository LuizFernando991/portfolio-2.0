...
export const translations = {
  'pt-BR': {
    ...
    blog: {
      metaTitle: 'Blog | Luiz Fernando',
      metaDescription: 'Artigos sobre desenvolvimento, arquitetura, backend, frontend e produto.',
      tag: '✦ Blog',
      title: 'Notas de campo sobre software.',
      description:
      ...
      previous: '← Anterior',
      next: 'Próxima →',
      empty: 'Nenhum post publicado com esses filtros ainda. Limpe uma opção para ver mais textos.',
      loadingFilters: 'Filtros carregando',
      loadingPosts: 'Posts carregando',
      loadingPostsText: 'Carregando posts',
      loadingReadingText: 'Preparando leitura',
      loading: 'Carregando',
      backToBlog: '← Voltar para o blog',
      readingMinute: 'min de leitura',
      notFoundTitle: 'Post não encontrado | Luiz Fernando',
    },
    footer: {
  ...
  'en-US': {
    ...
    blog: {
      metaTitle: 'Blog | Luiz Fernando',
      metaDescription: 'Articles about development, architecture, backend, frontend, and product.',
      tag: '✦ Blog',
      title: 'Field notes about software.',
      description:
        'Practical writing about backend, frontend, architecture, and product decisions that show up when an idea has to become a real system.',
      ...
      previous: '← Previous',
      next: 'Next →',
      empty: 'No published posts match these filters yet. Clear an option to see more writing.',
      loadingFilters: 'Filters loading',
      loadingPosts: 'Posts loading',
      loadingPostsText: 'Loading posts',
      loadingReadingText: 'Preparing reading',
      loading: 'Loading',
      backToBlog: '← Back to blog',
      readingMinute: 'min read',
      notFoundTitle: 'Post not found | Luiz Fernando',
    },
    footer: {
      copy: '© 2026 Luiz Fernando Rodrigues — Full-Stack Developer',
    },
