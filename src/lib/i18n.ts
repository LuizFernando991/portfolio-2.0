...
export const translations = {
  'pt-BR': {
    ...
    skills: {
      ...
      signalItems: ['Microservices', 'Clean Arch.', 'gRPC', 'Jest'],
      extraTechItems: [
        'Express',
        'MongoDB',
        'MySQL',
  ...
  'en-US': {
    ...
    projects: {
      ...
      items: [
        {
          title: 'Microservices Streaming',
          type: 'Main · Microservices',
          description:
            'Streaming platform being built with a microservices architecture. Communication via gRPC and RabbitMQ.',
          tags: ['NestJS', 'gRPC', 'Docker', 'AWS'],
          link: 'https://github.com/LuizFernando991',
          thumb: 'dark',
        },
        ...
        },
        {
          ...
          type: 'SaaS · Messaging',
          description:
            'Automated WhatsApp campaign system. Scheduling, speed control, and real-time monitoring with WebSocket.',
          tags: ['Node.js', 'WebSocket', 'API'],
          link: 'https://github.com/LuizFernando991',
          thumb: 'green',
        },
